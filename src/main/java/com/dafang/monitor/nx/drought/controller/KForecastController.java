...
import com.dafang.monitor.nx.drought.service.Impl.KForecastServiceImpl;
...
@Api(value = "干旱",tags = {"干旱K指数预测"})
@RestController
@RequestMapping(value = "drought/KForecast/")
public class KForecastController {

    @Autowired
    KForecastServiceImpl kForecastService;

    @PostMapping(value = "getKForecast")
    @ApiOperation(value = "干旱K指数预测",notes = "干旱K指数预测")
...
//        params.setStartDate("");
//        params.setEndDate("");
        List<Map<String,Object>> dataList = kForecastService.getKForecast(params);
