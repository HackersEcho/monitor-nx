...
@Data
@Builder
@ApiModel(value = "前端传入的霜冻站数参数实体类")
public class FrostStaParam implements Serializable {
    @JsonIgnore
    ...
    @ApiModelProperty(value = "开始月日",example = "0501")
    private String st;
    @ApiModelProperty(value = "结束月日",example = "1031")
    private String et;
